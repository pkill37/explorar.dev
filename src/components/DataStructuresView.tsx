...
const dataStructures: DataStructure[] = [
  {
    ...
    lineNumber: 178,
    introduction: "Many times operating systems need to hold a list of data structures. In order reduce code duplication the Linux's kernel developers created a standard implementation of a circular/doubly-linked list. This implementation was included in kernel 2.1.45.",
    usage: [
  ...
  },
  {
    ...
    filePath: "include/linux/types.h",
    lineNumber: 188,
    introduction: "Used together with struct hlist_node as part of hash tables. Has only one data member 'first' which points to the first node of a double linked list.",
    usage: [
  ...
  },
  {
    ...
    filePath: "include/linux/types.h",
    lineNumber: 192,
    introduction: "Used with struct hlist_head for hash tables. Has two fields: 'next' points to the next node, 'pprev' is a pointer to a pointer to the previous node.",
    usage: [
      "Used in conjunction with hlist_head",
      "Part of hash table implementations"
    ]
  },
  {
    ...
    lineNumber: 53,
    introduction: "Simple lock-free singly linked list implementation. Used for scenarios requiring lock-free operations.",
    usage: [
  ...
  },
  {
    ...
    lineNumber: 748,
    introduction: "The central data structure representing a process or thread in the Linux kernel. Contains all information needed to manage and schedule a task.",
    usage: [
  ...
  },
  {
    ...
    lineNumber: 601,
    introduction: "Represents a process's address space (virtual memory areas). Contains page tables, memory mappings, and memory management information.",
    usage: [
  ...
  },
  {
    ...
    filePath: "include/linux/mm_types.h",
    lineNumber: 490,
    introduction: "Represents a contiguous memory area in a process's address space. Used to track permissions, properties, and operations for each memory area.",
    usage: [
  ...
  },
  {
    ...
    lineNumber: 56,
    introduction: "Common low-level thread information accessors. Contains flags like signal pending, address space info, CPU-specific data. Architecture-dependent structure.",
    usage: [
      "Thread flags",
      "CPU-specific state",
  ...
  },
  {
    ...
    lineNumber: 473,
    introduction: "Holds CPU-specific state of a task including page fault information, register sets, and architecture-specific data. Must be at the end of task_struct on x86.",
    usage: [
      "CPU register state",
      "Page fault handling",
      "Context switching"
...
const DataStructureItem: React.FC<DataStructureItemProps> = ({ ds, onFileOpen }) => {
  ...
  return (
    <div className="data-structure-item">
      <div 
        className="data-structure-header"
